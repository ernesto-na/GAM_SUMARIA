     ...
     */
     ...
     //FileUploading is my MessageFileUpload Bean Id
      ...
      /*  System.out.println("uploadedByteStream---->"+uploadedByteStream);*/
         ...
         leer.readExcel(file);
           ...
           Rubro rubroI1=leer.prepareRI1();
            ...
            /*En este punto debemos borrar la tabla SAF_FLUJO_EFECTIVO*/
             ...
             try{
                 OAApplicationModule am = pageContext.getApplicationModule(webBean);
                 Serializable[] param = {testRubro.getUnOper(),testRubro.getP_final(),testRubro.getMoneda()};
           ...
           try{
            OAApplicationModule am = pageContext.getApplicationModule(webBean);
            Serializable[] param2 = {rubro4.getUnOper(),rubro4.getId_rubro(),rubro4.getRubro(),rubro4.getP_inicial(),rubro4.getP_final(),rubro4.getCOST_SALDO_INICIAL(),rubro4.getDPRN_INITIAL_BALANCE(),rubro4.getCOST_ADDITIONS(),rubro4.getCOST_BAJAS(),rubro4.getCOST_TRANSFERS_SALE(),rubro4.getDPN_DEPRECIACION(),rubro4.getDPN_BAJAS(),rubro4.getDPN_VAR_TIP_CAMBIO(),rubro4.getCOST_VAR_TIP_CAMBIO(),rubro4.getCOST_SALDO_FINAL(),rubro4.getDPN_SALDO_FINAL(),rubro4.getMoneda()};
            System.out.println("Entrando en exec_insert...");
            am.invokeMethod("exec_insert",param2);
            System.out.println("Saliendo de.. exec_insert...");
        }catch(Exception e){
       ...
       try{
          OAApplicationModule am = pageContext.getApplicationModule(webBean);
          Serializable[] param2 = {rubro10.getUnOper(),rubro10.getId_rubro(),rubro10.getRubro(),rubro10.getP_inicial(),rubro10.getP_final(),rubro10.getCOST_SALDO_INICIAL(),rubro10.getDPRN_INITIAL_BALANCE(),rubro10.getCOST_ADDITIONS(),rubro10.getCOST_BAJAS(),rubro10.getCOST_TRANSFERS_SALE(),rubro10.getDPN_DEPRECIACION(),rubro10.getDPN_BAJAS(),rubro10.getDPN_VAR_TIP_CAMBIO(),rubro10.getCOST_VAR_TIP_CAMBIO(),rubro10.getCOST_SALDO_FINAL(),rubro10.getDPN_SALDO_FINAL(),rubro10.getMoneda()};
          System.out.println("Entrando en exec_insert...");
          am.invokeMethod("exec_insert",param2);
          System.out.println("Saliendo de.. exec_insert...");
       }catch(Exception e){
